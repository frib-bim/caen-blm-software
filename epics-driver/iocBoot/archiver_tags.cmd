...
reAddInfo "^.*:(FC|HMR|IC|ND)_D.*[_:]AVGS_RD$" "archive" "scan:0.5,retention:3mo"
reAddInfo "^.*:(FC|HMR|IC|ND)_D.*[_:]AVG_RD$" "archive" "scan:2.0,retention:inf"
reAddInfo "^.*:(FC|HMR|IC|ND)_D.*[_:]LAVG_RD$" "archive" "scan:1.0,retention:3mo"
reAddInfo "^.*:(FC|HMR|IC|ND)_D.*[_:]STD_RD$" "archive" "scan:1.0,retention:3mo"
...
reAddInfo "^.*:EMS_D.*[_:]AVG_RD$" "archive" "scan:2.0,retention:3mo"
reAddInfo "^.*:PM_D.*[_:]AVG_RD$" "archive" "scan:2.0,retention:3mo"
...
reAddInfo "^.*_CTRL:PLSCNT_RD$" "archive" "scan:1.0,retention:inf"
reAddInfo "^.*_D.*:.*PKAVG_RD$" "archive" "scan:0.1,retention:12mo"
reAddInfo "^.*_FPS:(NOK|NOKLTH)_RSTS$" "archive" "monitor:1.0,retention:inf"

...
# (SYS):(D)_CHX:Y_Z
dbLoadRecords("../../db/pico8_frib.db","SYS=DIAG_MTCA,D=PICO3,NAME=PICO3")
dbLoadRecords("../../db/pico8_frib.db","SYS=DIAG_MTCA,D=PICO4,NAME=PICO4")
dbLoadRecords("../../db/pico8_frib.db","SYS=DIAG_MTCA,D=PICO5,NAME=PICO5")
dbLoadRecords("../../db/pico8_frib.db","SYS=DIAG_MTCA,D=PICO6,NAME=PICO6")
dbLoadRecords("../../db/pico8_frib.db","SYS=DIAG_MTCA,D=PICO7,NAME=PICO7")
dbLoadRecords("../../db/pico8_frib.db","SYS=DIAG_MTCA,D=PICO8,NAME=PICO8")
dbLoadRecords("../../db/pico8_frib.db","SYS=DIAG_MTCA,D=PICO9,NAME=PICO9")

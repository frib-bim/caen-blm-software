...
createPICO8("PICO5", "/dev/amc_pico_0000:09:00.0", "$(PICO_RATE_LIMIT)")
createPICO8("PICO6", "/dev/amc_pico_0000:0b:00.0", "$(PICO_RATE_LIMIT)")
createPICO8("PICO7", "/dev/amc_pico_0000:0f:00.0", "$(PICO_RATE_LIMIT)")
createPICO8("PICO8", "/dev/amc_pico_0000:0d:00.0", "$(PICO_RATE_LIMIT)")
createPICO8("PICO9", "/dev/amc_pico_0000:07:00.0", "$(PICO_RATE_LIMIT)")

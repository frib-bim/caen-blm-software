...
def acqCBufCallback(value):
    ...
    dev.set('_CH0:DDRWV_RD', dat.ch0 * 1e6);
    dev.set('_CH1:DDRWV_RD', dat.ch1 * 1e6);
    dev.set('_CH2:DDRWV_RD', dat.ch2 * 1e6);
    dev.set('_CH3:DDRWV_RD', dat.ch3 * 1e6);
    dev.set('_CH4:DDRWV_RD', dat.ch4 * 1e6);
    dev.set('_CH5:DDRWV_RD', dat.ch5 * 1e6);
    dev.set('_CH6:DDRWV_RD', dat.ch6 * 1e6);
    dev.set('_CH7:DDRWV_RD', dat.ch7 * 1e6);
